...
using System.Linq;
using System.Text;
using GoLive.AnyDiff.Extensions;
...
namespace AnyDiff.Tests
{
    ...
    class PathTests
    {
        ...
        public void ShouldInclude_ArrayIndex_InPath()
        {
            ...
            Assert.AreEqual(".bs[0].cs[0].ii[2]", diff.First().CsPath);
        }
        ...
        public void ShouldInclude_ArrayIndex_InPath_WhenSizeIsDifferent()
        {
            ...
            var diff = obj1.Diff(obj2);
            Assert.AreEqual(".bs[0].cs[0].ii[4]", diff.First().CsPath);
            Assert.AreEqual(".bs[0].cs[0].ii[5]", diff.ElementAt(1).CsPath);
        }
        ...
        public void ShouldInclude_ArrayIndex_InPath_WhenSizeIsDifferent2()
        {
            ...
            var diff = obj1.Diff(obj2);
            Assert.AreEqual(".bs[0].cs[0].ii[3]", diff.First().CsPath);
            Assert.AreEqual(".bs[0].cs[0].ii[2]", diff.ElementAt(1).CsPath);
        }
